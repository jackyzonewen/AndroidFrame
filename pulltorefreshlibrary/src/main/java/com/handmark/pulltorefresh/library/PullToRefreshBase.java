...
//		return mHeaderLayout.getContentSize();
	...
	private void init(Context context, AttributeSet attrs) {
        mHeadLayoutHeight= (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics());
//        mHeadLayoutHeight=(int)context.getResources().getDimension(R.dimen.header_height);
		switch (getPullToRefreshScrollDirection()) {
			case HORIZONTAL:
